...
import perobobbot.plugin.twitch.chat.TwitchChatAuthenticationFailure;
...
public class Nick extends RequestToTwitch<GlobalUserState> {
    ...
    public @NonNull Optional<TryResult<Throwable, GlobalUserState>> isMyAnswer(
        ...
        return CastTool.castAndCall(messageFromTwitch, GlobalUserState.class, this::checkGlobalUserState)
