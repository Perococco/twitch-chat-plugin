...
import perobobbot.plugin.twitch.chat.message.to.Cap;
import perobobbot.plugin.twitch.chat.message.to.Nick;
import perobobbot.plugin.twitch.chat.message.to.Pass;
import perobobbot.plugin.twitch.chat.message.to.Pong;
import perobobbot.lang.*;
import perococco.perobobbot.plugin.twitch.chat.actions.JoinChannel;
import perococco.perobobbot.plugin.twitch.chat.actions.SetupTimeout;
import perococco.perobobbot.plugin.twitch.chat.state.ConnectionState;
import perococco.perobobbot.plugin.twitch.chat.state.StateUpdater;
import perococco.perobobbot.plugin.twitch.chat.state.mutator.*;
...
public class TwitchChatConnection implements ChatConnection, AdvancedChatListener<MessageFromTwitch> {
    ...
    public TwitchChatConnection(@NonNull ChatConnectionInfo chatConnectionInfo,
        ...
        this.credential = new Credential(chatConnectionInfo.getNick(), chatConnectionInfo.getSecret());
